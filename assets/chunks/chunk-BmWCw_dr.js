import{KA as Pe,Kx as be,L2 as ve,Ij as _,Iu as E,KC as De,Je as B,Ik as r,d8 as N,Il as te,Kz as we,Is as A,x$ as Ee,eg as b,cr as ie,ba as h,gC as R,d4 as F,L3 as Ve,kL as ne,Ii as se,Jx as T,cq as v,L4 as ae,bv as re,bw as le,d3 as xe,d0 as Le,mO as Se,l$ as ye,cC as Ce,d1 as Ae,bb as oe,Iv as ce,Iw as he,J4 as Te,cp as G,cu as j,Ky as Me,rU as $e,jh as Re,Jv as Ue,K3 as Ie,bf as o,Jd as K,bg as Oe,b9 as I,me as qe,db as de,br as z,xU as je,im as ze,ma as Ne,mb as We,L5 as He,aj as g,II as x,KG as Be,KH as k,L6 as Fe,L7 as Ge,lU as Ke,KI as c,L8 as U,L9 as ke,st as X,cw as Xe,cx as Je,uI as Ye,cz as Ze,cA as Qe,cB as et,ak as M,am as tt,La as it,mS as J}from"./chunk-XGpVqsM_.js";import{t as nt}from"./chunk-FFoKj2y0.js";import{_ as pe}from"./chunk-Dix477Sg.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(ve),n.uniforms.add(new _("globalAlpha",(i=>i.globalAlpha)),new E("glowColor",(i=>i.glowColor)),new _("glowWidth",((i,s)=>i.glowWidth*s.camera.pixelRatio)),new _("glowFalloff",(i=>i.glowFalloff)),new E("innerColor",(i=>i.innerColor)),new _("innerWidth",((i,s)=>i.innerWidth*s.camera.pixelRatio)),new De("depthMap",(i=>i.depth?.attachment)),new B("normalMap",(i=>i.normals))),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return true;
}`),e.contrastControlEnabled?n.uniforms.add(new B("frameColor",((i,s)=>i.colors)),new _("globalAlphaContrastBoost",(i=>i.globalAlphaContrastBoost))).code.add(r`float rgbToLuminance(vec3 color) {
