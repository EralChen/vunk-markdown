---
title: Render Tag 渲染标签
description: Render Tag 渲染标签 相关说明与示例。
---
...
:component-example{name="RenderTagBasic"}

## A

:component-example{name="RenderTagA"}

## 使用方法

`markdown-exit` 解析的标签对, 将包含在 `GroupToken` 中, 由 [Templatetype GroupToken](/docs/guide/basic/render#templatetype-grouptoken) 对应的渲染器渲染。
