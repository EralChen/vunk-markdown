---
title: Markdown It Setup 扩展
description: Markdown It Setup 扩展 相关说明与示例。
---
...
:component-example{name="MarkdownItSetupBasic"}
...
由于 @vunk/markdown 会优先经历 [解析](/docs/guide/basic/parse) 阶段，它并不会直接将文本转化为 HTML。
